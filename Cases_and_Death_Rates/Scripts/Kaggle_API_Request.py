...
df1 = pd.read_csv(
    ...
    dtype='unicode')
df2 = pd.read_csv('A:\College\DAP-Project\Cases_and_Death_Rates\Data\Raw Data for EDA\CONVENIENT_global_deaths.csv',
                  dtype='unicode')
df3 = pd.read_csv(
    'A:\College\DAP-Project\Cases_and_Death_Rates\Data\Raw Data for EDA\CONVENIENT_us_confirmed_cases.csv',
    dtype='unicode')
df4 = pd.read_csv('A:\College\DAP-Project\Cases_and_Death_Rates\Data\Raw Data for EDA\CONVENIENT_us_deaths.csv',
                  dtype='unicode')
